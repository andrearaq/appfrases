...
var WebSqlAdapter = function () {
    ...
    this.encontrarFrasesOrdenar = function () {
        var deferred = $.Deferred();
        this.db.transaction(
            function (tx) {
                var sql="";
    ...
    var insertarDatosF = function (tx, frases) {
        ...
        var frases = [
        {"id": 1, "texto": "El perro hace caca"},
        {"id": 2, "texto": "El perro salta y corre"},
        {"id": 3, "texto": "El perro negro salta y corre"},
        {"id": 4, "texto": "Yo tengo frio"},
        {"id": 5, "texto": "Yo duermo en la cama"},
    ];
        ...
        for (var i = 0; i < l; i++) {
            e = frases[i];
            tx.executeSql(sql, [e.id, e.texto],
                function () {
